...
- `sensitive` (Boolean) Whether the value of this parameter is sensitive. Sensitive parameter values are encrypted at rest and redacted when returned by the Coder API.
